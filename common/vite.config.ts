...
export function defineConfig(config?: UserConfig | UserConfigFnObject) {
  if (config instanceof Function) {
    return ViteDefineConfig(function (...args) {
      return mergeWith({}, baseConfig, config(...args), customizer);
    });
  }
  return ViteDefineConfig(mergeWith({}, baseConfig, config, customizer));
}
